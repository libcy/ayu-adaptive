...
class ContributionsApi extends basem.ClientApiBase {
    ...
    queryContributionNodes(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                let routeValues = {};
                try {
                    let verData = yield this.vsoClient.getVersioningData("4.1-preview.1", "Contribution", "db7f2146-2309-4cee-b39c-c767777a1c55", routeValues);
     ...
     */
    queryDataProviders(query, scopeName, scopeValue) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                let routeValues = {
                    scopeName: scopeName,
                ...
                try {
                    let verData = yield this.vsoClient.getVersioningData("4.1-preview.1", "Contribution", "738368db-35ee-4b85-9f94-77ed34af2b0d", routeValues);
                    let url = verData.requestUrl;
                    let options = this.createRequestOptions('application/json', verData.apiVersion);
                    let res;
                    res = yield this.rest.create(url, query, options);
    ...
    getInstalledExtensions(contributionIds, includeDisabledApps, assetTypes) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    let verData = yield this.vsoClient.getVersioningData("4.1-preview.1", "Contribution", "2648442b-fd63-4b9a-902f-0c913510f139", routeValues, queryValues);
                    let url = verData.requestUrl;
                    let options = this.createRequestOptions('application/json', verData.apiVersion);
                    let res;
    ...
    getInstalledExtensionByName(publisherName, extensionName, assetTypes) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    let verData = yield this.vsoClient.getVersioningData("4.1-preview.1", "Contribution", "3e2f6668-0798-4dcb-b592-bfe2fa57fde2", routeValues, queryValues);
                    let url = verData.requestUrl;
                    let options = this.createRequestOptions('application/json', verData.apiVersion);
                    let res;
                    res = yield this.rest.get(url, options);
...
ContributionsApi.RESOURCE_AREA_ID = "8477aec9-a4c7-4bd4-a456-ba4c53c989cb";
