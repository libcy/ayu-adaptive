...
const accountm = require("./AccountsApi");
...
class WebApi {
    ...
    getAccountsApi(serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: Load RESOURCE_AREA_ID correctly.
            serverUrl = yield this._getResourceAreaUrl(serverUrl || this.serverUrl, "0d55247a-1c47-4462-9b1f-5e2125590ee6");
    ...
    getChatApi(serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: Load RESOURCE_AREA_ID correctly.
            serverUrl = yield this._getResourceAreaUrl(serverUrl || this.serverUrl, "1e984811-4250-48bd-9c57-fe40eab4a630");
            handlers = handlers || [this.authHandler];
    ...
    getContributionsApi(serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: Load RESOURCE_AREA_ID correctly.
            serverUrl = yield this._getResourceAreaUrl(serverUrl || this.serverUrl, "8477aec9-a4c7-4bd4-a456-ba4c53c989cb");
            handlers = handlers || [this.authHandler];
    ...
    getGalleryApi(serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: Load RESOURCE_AREA_ID correctly.
            serverUrl = yield this._getResourceAreaUrl(serverUrl || this.serverUrl, "69d21c00-f135-441b-b5ce-3626378e0819");
            handlers = handlers || [this.authHandler];
    ...
    getIdentitiesApi(serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: Load RESOURCE_AREA_ID correctly.
            serverUrl = yield this._getResourceAreaUrl(serverUrl || this.serverUrl, "8a3d49b8-91f0-46ef-b33d-dda338c25db3");
            handlers = handlers || [this.authHandler];
    ...
    getTokenApi(serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: Load RESOURCE_AREA_ID correctly.
            serverUrl = yield this._getResourceAreaUrl(serverUrl || this.serverUrl, "");
            handlers = handlers || [this.authHandler];
